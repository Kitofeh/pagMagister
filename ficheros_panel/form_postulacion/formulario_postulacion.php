...
<nav class="navbar navbar-dark fixed-top" style="background-color: #364c59;">
  ...
  <br>   
  <a href="nueva_postulacion.php" class="m-3 btn btn-dark">Agregar</a>   
  </div>
    <center>
    <table class="table">
    <thead>
      <tr>
        ...
        <th colspan="2">CAMPO DE ESTUDIO</th>
      </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr>
      ...
      <td>
        <a href="modificar_postulacion.php?RUT=<?php echo $fila["RUT"]; ?>" class="btn btn-warning">EDITAR</a>
        <a href="eliminar_postulacion.php?RUT=<?php echo $fila["RUT"]; ?>" class="btn btn-danger">ELIMINAR</a>        </td>
    </tr>
  </tbody>
  <?php } ?>
  </table>
