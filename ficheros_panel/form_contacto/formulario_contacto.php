...
<nav class="navbar navbar-dark fixed-top" style="background-color: #364c59;">
    ...
    <div class="modal-dialog">
        ...
        <form action ="agregar_contacto.php" method="POST" enctype="multipart/form-data" autocomplete="off">
    ...
    <tr>
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModificarEvento<?php echo $fila['RUT'];?>">Modificar</button></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">MODIFICAR CONTACTO</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">

                <form action="actualizar_contacto.php?IdEditar=<?php echo $fila["RUT"]?>" method="POST" autocomplete="off">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
                ...
                <a href="eliminar_contacto.php?id=<?php echo $fila['RUT'] ?>" class="btn btn-danger">Eliminar</a>
            </div>
            </div>
        </div>
        </div>
