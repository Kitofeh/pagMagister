...
<body>
    ...
    $con = conectar();
    $RUT = $_REQUEST['RUT'];
    $sql = "SELECT * FROM formulario_contacto WHERE RUT = $RUT";
    ...
    <form action ="actualizar_contacto.php?IdEditar=<?php echo $fila["RUT"]?>" method="POST" enctype="multipart/form-data">
